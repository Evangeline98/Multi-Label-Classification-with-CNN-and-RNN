...
def train(args, model: nn.Module, criterion, *, params,folds, count,
    ...
    pretrain_path = Path('../input/modelcbam2')/'model.pt'
   ...
   ##############
    ...
    # C is the number of classes.
            ...
            valid_loss = valid_metrics['valid_f2_th_0.10']
...
criterion = nn.BCEWithLogitsLoss(reduction='none',pos_weight = (torch.ones([1103])*1.5).cuda())
